        ...
        <div>
          ...
          <div className="mb-[3rem] flex item-center   md:space-x-10  ">
            ...
            <p className="text-[18px] text-slate-300 w-[100%]">
              ...
              Perferendis tempora excepturi voluptatum provident iure recusandae
              ullam corporis nemo, nobis odit deleniti animi delectus eaque
              dolorum modi perspiciatis, velit sapiente mollitia.
            </p>
          </div>
        </div>
          <div className="lg:w-[500px] mx-auto relative md:mx-0 lg:mt-16 lg:h-[500px] w-[300px] h-[300px] pt-10 ">
            <img
            src={user}
            alt="user"
